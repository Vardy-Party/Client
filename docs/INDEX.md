...
### For Developers
- **[architecture/README.md](architecture/README.md)** - App architecture canvas + plan (domain assemblies, shared VMs). Phase 2: [phase-2-plan.md](architecture/phase-2-plan.md). Phase 3 UI: [phase-2-webview-xaml.md](architecture/phase-2-webview-xaml.md).
